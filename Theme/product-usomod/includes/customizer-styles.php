...
function twx_custom_styles( $customizer_style ) {
	...
	//Background color
	$primary_color = get_theme_mod( 'primary_color', '#497991' );
	...
	//Theme text color
	$theme_text_color = get_theme_mod( 'theme_text_color', '#676a6b' );
	...
	$main_footer_bg = get_theme_mod( 'main_footer_bg', '#709fb7' );
	$customizer_style .= '.site-footer{background-color: ' . esc_attr($main_footer_bg).';} ';
	
	//footer  text color
	$main_footer_color = get_theme_mod( 'main_footer_color', '#ffffff' );
	$customizer_style .= '.site-footer, .site-footer a {color: ' . esc_attr($main_footer_color).';} ';
